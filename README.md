...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/mywifiapp)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/mywifiapp
```

A live public deployment of this template is available at [https://mywifiapp.templates.workers.dev](https://mywifiapp.templates.workers.dev)
